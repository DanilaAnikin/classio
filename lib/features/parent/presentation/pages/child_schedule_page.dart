...
/// Child Schedule Page for Parent.
///
/// Shows the child's weekly class schedule with a day selector
/// and timeline view of lessons.
class ChildSchedulePage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ChildSchedulePage> createState() => _ChildSchedulePageState();
}

class _ChildSchedulePageState extends ConsumerState<ChildSchedulePage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.invalidate(childWeeklyScheduleProvider(widget.childId));
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final weeklySchedule = ref.watch(childWeeklyScheduleProvider(widget.childId));

    return Scaffold(
      appBar: AppBar(
        title: const Text('Child\'s Schedule'),
        centerTitle: true,
        leading: IconButton(
            ...
            Expanded(
              child: weeklySchedule.when(
                ...
                error: (e, _) => _ErrorState(
                  ...
                  isPlayful: isPlayful,
                  onRetry: () => ref.invalidate(childWeeklyScheduleProvider(widget.childId)),
                ),
              ),
            ),
          ],
